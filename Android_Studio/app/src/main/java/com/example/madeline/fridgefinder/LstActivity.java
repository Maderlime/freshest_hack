...
import com.example.madeline.fridgefinder.db.*;
import com.example.madeline.fridgefinder.helperClasses.*;
...
public class LstActivity extends AppCompatActivity {
    ...
    private void updateUI(){
        ...
        //get the database values using cursor
